class Definer {
  ...
  static article_err1 = "att: auth member for articles not provided !";
  ...
  static follow_err1 = "att: self subcription is denied !";
  static follow_err2 = "att: new follow subcription is failed !";
